...
def main(robot, planning_env, planner):
    ...
    print("goal is {}".format(goal_config))
    # planning_env.SetGoalParameters(numpy.array([ 3.68, -1.90,  0.00,  2.20,  0.00,  0.00,  0.00 ]),0.2)
    dist = planning_env.SetGoalParameters(goal_config)
...
if __name__ == "__main__":
    ...
    if args.robot == 'herb':
        ...
        # planning_env.GenerateRandomConfiguration()
        visualize = False
